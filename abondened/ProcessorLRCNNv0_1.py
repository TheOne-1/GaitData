...
class ProcessorLRCNNv0_1(ProcessorLR):
    ...
    def convert_input(self, input_all_list, sampling_fre):
        ...
        sample_before_strike = int(14 * (sampling_fre / 100))
        sample_after_strike = int(10 * (sampling_fre / 100))
    ...
    def cnn_solution(self):
        ...
        model.add(Conv1D(filters=100, kernel_size=15, input_shape=input_shape[1:]))
